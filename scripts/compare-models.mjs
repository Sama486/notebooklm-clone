...
const PASSAGES = [
  ...
  'Die Ähnlichkeitssuche ist ein exakter Durchlauf über alle Abschnitte eines Notebooks. Bei zehntausend Abschnitten dauert die Datenbankabfrage vierzehn Sekunden, die Rangfolge im Speicher dagegen nur neun Millisekunden.',
